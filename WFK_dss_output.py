 ...
 'JUNCTION - OUTFLOW']
    ...
    def run(self):
        ...
        for event in self.events:
            dss_file = os.path.join("WFK_{}yrStorm".format(event), "MSE4_No_Dams.dss")
...
#         dss_file = os.path.join("CoonCreek_100yrStorm", "MSE4_No_Dams.dss")
#         event = "100"
#         event_dict[event] = self.out_data(dss_file, event)
        ...
        with open(os.path.join("CompiledDataFromDSS_{}.json".format('overwrite')), "w") as outfile:
